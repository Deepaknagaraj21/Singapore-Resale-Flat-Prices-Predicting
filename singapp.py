...
data = pd.read_csv(r'C:\Users\Ndeep\Desktop\mrt.csv')
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                with open(r"C:\Users\Ndeep\Desktop\model.pkl", 'rb') as file:
                    loaded_model = pickle.load(file)
                with open(r'C:\Users\Ndeep\Desktop\scaler.pkl', 'rb') as f:
